...
public class BarberServicesAdapter extends RecyclerView.Adapter<BarberServicesAdapter.ViewHolder>
{
    public List<Service> services;

    public BarberServicesAdapter(List<Service> services) { this.services = services; }
    ...
    @Override
    public void onBindViewHolder(@NonNull BarberServicesAdapter.ViewHolder holder, int position) {
